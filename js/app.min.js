...
const calc = () => {
    ...
    if (calcs.length) {
        calcs.forEach((calc) => {
            ...
            volumeYear.innerHTML = (powerInput * 1.08 * 1000).toFixed(2);
            volumeMonth.innerHTML = (volumeYear.innerHTML / 12).toFixed(2);
            savingYear.innerHTML = (volumeYear.innerHTML * index).toFixed(2);
            savingMonth.innerHTML = (savingYear.innerHTML / 12).toFixed(2);
            square.innerHTML = (powerInput * 6.8).toFixed(2);
            term.innerHTML = (summInput / savingYear.innerHTML).toFixed(2);
        });
    }
}
